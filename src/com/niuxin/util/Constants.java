...
public class Constants {
	...
	public static final String SERVER_IP = "115.28.242.139"; // 服务器ip  115.28.242.139
	public static final String SERVER_PORT = "8083";//保存ip、port的xml文件名
//	public static final int REGISTER_FAIL = 0;//注册失败
	...
	public static final String DBNAME = "niuxin.db";//数据库名称
}
