...
public class KlineSetActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_kset_finish.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				{
					case 1://日
						Intent intent = new Intent(KlineSetActivity.this,KlineDayActivity.class);
						startActivity(intent);
						break;
					case 2://周
						Intent intent01 = new Intent(KlineSetActivity.this,KlineActivity.class);
		...
		btn_k_add.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(KlineSetActivity.this,zixuan_addActivity.class);
				startActivity(intent);
