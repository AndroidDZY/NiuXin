...
public class Tag_ManageActivity extends Activity{
	Button btn_tag_cancle,btn_tag_finish;
	ImageButton btn_tag_add,btn_tag_delete;
	ListView listView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_tag_add = (ImageButton)findViewById(R.id.btn_tag_add);
		...
		btn_tag_finish.setOnClickListener(new OnClickListener() {
